...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/easystac-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15579&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/easystac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `easystac` can be installed with:

```
conda install easystac
```

It is possible to list all of the versions of `easystac` available on your platform with:
